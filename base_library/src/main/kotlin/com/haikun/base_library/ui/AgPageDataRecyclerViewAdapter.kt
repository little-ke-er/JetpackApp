 ...
 *
 */
abstract class AgPagingDataRecyclerViewAdapter<T:Any, V : ViewDataBinding>(diffCallback: DiffUtil.ItemCallback<T>) :
    PagingDataAdapter<T, AgPagingDataRecyclerViewHolder<V>>(diffCallback),IAgRecyclerViewAdapter<T>  {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AgPagingDataRecyclerViewHolder<V> {
        return AgPagingDataRecyclerViewHolder(
            createBinding(
                parent,
                viewType
            )
    ...
    override fun onBindViewHolder(holder: AgPagingDataRecyclerViewHolder<V>, position: Int) {
...
class AgPagingDataRecyclerViewHolder<out T : ViewDataBinding>(val viewDataBinding: T) :
